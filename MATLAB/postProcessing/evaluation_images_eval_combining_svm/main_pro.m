...
%% 
svm_classifier_names = {  'classifier_Posterior_pro', 'classifier_Posterior_feature.mat',};
layer = {'prob' , 'fc6'};
	...
	for p=1:length(patientNum_)
		...
		for  i =1:num_images
		   ...
		   [DiceCoeff , Accuracy ] = onCombining(anno_im(:,:,1) , im_i , svm_classifier_names{cn} , layer{cn});
			...
			%% save results
			save (['diceCoeff_data' svm_classifier_names{cn}] 'diceCoeff_data');
			save (['Accuracy_data' svm_classifier_names{cn}] 'Accuracy_data');
