...
def my_model_def (input_dim = (3,128,128), nb_classes=3):
    ...
    conv1 = Conv2D(96, (7, 7), padding='same', activation='relu', strides=(4, 4), kernel_initializer='he_normal')(norma1)
    pool1 = MaxPool2D(pool_size=(3, 3), strides=(2, 2),padding='same')(conv1)



    conv2 = Concatenate(axis=1)([Conv2D(128, (5, 5), activation="relu", strides=(2, 2), padding='same',kernel_initializer='he_normal',name='conv2_' + str(i + 1))(splittensor(ratio_split=2, id_split=i)(pool1)) for i in range(2)])
