...
create_training_db= False  # if False create validation database
...
if create_training_db:
	...
	data_path = 'F:/Project_Files/Code/Python/python_patches_folder/training'
...
def create_database(muscle_per, cancer_per, normal_per, total):
    i = 0
